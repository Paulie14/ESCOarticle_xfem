...
Without loose of generality, let us assume a square on the $X$-axis. Since $\abs{y}<\delta \ll \abs{x}$ the monomials of $\Pi^n f$ containing $y$ 
...
\[
  \int_S \abs{f-\Pi^n f} \le \int_{S'}\abs{f-\Pi^n f} \le \delta E^n((r_{S}, r_{S}+\delta)).
\]
