...
compare our solution with the original one (developed in \cite{gracie}) in the following subsection. 
...
as in the quadrature used by G. and C. in \cite{gracie}. Using the proposed rules, the elements that do not contain the well are refined as well,
