...
The improved adaptive quadrature is computed as desribed above. Notice the scale of the improved version -- 
...
In this section, we shall study dependence of the solution error on the enrichement radius $R$. First part is devoted to 
