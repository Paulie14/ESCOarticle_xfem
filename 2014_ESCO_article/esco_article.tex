...
in particular validation of convergence, behaviour of the condition number, a set of experiments validating some of the theoretical results and convergence tests.
